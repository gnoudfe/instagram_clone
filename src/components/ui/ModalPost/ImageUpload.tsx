  ...
  return (
    <div className="relative z-10 w-full max-w-[692px] h-[660px] rounded-sm flex flex-col">
      ...
      >
        ...
        <span className="text-white font-semibold">Upload a photo here</span>
        <label
          htmlFor="file-upload"
          className="font-medium focus:outline-none transition-colors flex items-center justify-center gap-2  py-1.5 px-3 text-sm bg-blue-500 hover:bg-blue-600 text-white rounded-md cursor-pointer mt-3"
        >
